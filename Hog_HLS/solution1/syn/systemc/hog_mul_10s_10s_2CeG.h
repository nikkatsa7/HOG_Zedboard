...
#ifndef __hog_mul_10s_10s_2CeG__HH__
#define __hog_mul_10s_10s_2CeG__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hog_mul_10s_10s_2CeG) {
    ...
    SC_CTOR(hog_mul_10s_10s_2CeG):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
