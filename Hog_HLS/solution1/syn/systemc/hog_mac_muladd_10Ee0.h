...
#ifndef __hog_mac_muladd_10Ee0__HH__
#define __hog_mac_muladd_10Ee0__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(hog_mac_muladd_10Ee0) {
    ...
    SC_CTOR(hog_mac_muladd_10Ee0):  simcore_mac_0_U ("simcore_mac_0_U") {
