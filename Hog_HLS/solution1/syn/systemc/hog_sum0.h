...
#ifndef __hog_sum0_H__
#define __hog_sum0_H__
...
struct hog_sum0_ram : public sc_core::sc_module {
...
hog_sum0_ram* meminst;


SC_CTOR(hog_sum0) {
meminst = new hog_sum0_ram("hog_sum0_ram");
