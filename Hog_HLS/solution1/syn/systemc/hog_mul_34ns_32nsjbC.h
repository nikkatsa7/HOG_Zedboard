...
#ifndef __hog_mul_34ns_32nsjbC__HH__
#define __hog_mul_34ns_32nsjbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hog_mul_34ns_32nsjbC) {
    ...
    SC_CTOR(hog_mul_34ns_32nsjbC):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
