...
#ifndef __hog_mul_mul_10ns_DeQ__HH__
#define __hog_mul_mul_10ns_DeQ__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hog_mul_mul_10ns_DeQ) {
    ...
    SC_CTOR(hog_mul_mul_10ns_DeQ):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
