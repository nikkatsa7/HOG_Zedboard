...
set Interfaces {
    ...
    s_axi_SPECS {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_SPECS"
        param_prefix "C_S_AXI_SPECS"
        addr_bits "5"
        port_width "AWADDR 5 WDATA 32 WSTRB 4 ARADDR 5 RDATA 32"
        registers {}
        memories "specs {base_address 16 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CONTROL_BUS s_axi_SPECS m_axi_INPUT_IMAGE"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_INPUT_IMAGE {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_INPUT_IMAGE"
        data_width "32"
        param_prefix "C_M_AXI_INPUT_IMAGE"
...
## System Info
set user_parameters_list {clk_period 6.000000 machine 64 combinational 0 latency 1787 II x}
...
set enable_xo_gen 0
set kernel_files {/home/nick/Documents/student_xohw18-222_Nikolaos_Bellas_20180630_1/src/c/hog.cpp}
if {$enable_xo_gen} {
